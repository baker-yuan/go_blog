...
var (
	...
	E_Resource = &file_google_api_resource_proto_extTypes[1]
)
...
var file_google_api_resource_proto_depIdxs = []int32{
	...
	4, // 2: google.api.resource:extendee -> google.protobuf.MessageOptions
	2, // 3: google.api.resource_reference:type_name -> google.api.ResourceReference
	1, // 4: google.api.resource:type_name -> google.api.ResourceDescriptor
