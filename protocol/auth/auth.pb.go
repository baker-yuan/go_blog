...
// AuthorityType 权限类型枚举
type RoleAuthorityAuthorityType int32

const (
	RoleAuthorityAuthorityType_UNKNOWN_AUTHORITY_TYPE RoleAuthorityAuthorityType = 0 // 未知类型
	RoleAuthorityAuthorityType_MENU                   RoleAuthorityAuthorityType = 1 // 菜单
	RoleAuthorityAuthorityType_RESOURCE               RoleAuthorityAuthorityType = 2 // 资源
)

// Enum value maps for RoleAuthorityAuthorityType.
var (
	RoleAuthorityAuthorityType_name = map[int32]string{
		0: "UNKNOWN_AUTHORITY_TYPE",
		1: "MENU",
		2: "RESOURCE",
	}
	RoleAuthorityAuthorityType_value = map[string]int32{
		"UNKNOWN_AUTHORITY_TYPE": 0,
		"MENU":                   1,
		"RESOURCE":               2,
	}
)

func (x RoleAuthorityAuthorityType) Enum() *RoleAuthorityAuthorityType {
	p := new(RoleAuthorityAuthorityType)
	*p = x
	return p
}

func (x RoleAuthorityAuthorityType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RoleAuthorityAuthorityType) Descriptor() protoreflect.EnumDescriptor {
	return file_auth_auth_proto_enumTypes[2].Descriptor()
}

func (RoleAuthorityAuthorityType) Type() protoreflect.EnumType {
	return &file_auth_auth_proto_enumTypes[2]
}

func (x RoleAuthorityAuthorityType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RoleAuthorityAuthorityType.Descriptor instead.
func (RoleAuthorityAuthorityType) EnumDescriptor() ([]byte, []int) {
...
type Menu struct {
	...
	Describe   string `protobuf:"bytes,3,opt,name=describe,proto3" json:"describe,omitempty"`                         // 功能描述
	Path       string `protobuf:"bytes,4,opt,name=path,proto3" json:"path,omitempty"`                                 // 对应路由path
	Component  string `protobuf:"bytes,5,opt,name=component,proto3" json:"component,omitempty"`                       // 对应路由组件component
	IsHidden   bool   `protobuf:"varint,6,opt,name=is_hidden,json=isHidden,proto3" json:"is_hidden,omitempty"`        // 是否隐藏
	SortValue  uint32 `protobuf:"varint,7,opt,name=sort_value,json=sortValue,proto3" json:"sort_value,omitempty"`     // 排序
	Icon       string `protobuf:"bytes,8,opt,name=icon,proto3" json:"icon,omitempty"`                                 // 菜单图标
	ParentId   uint32 `protobuf:"varint,9,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`        // 父级菜单id
...
type Resource struct {
	...
	ResourceType     ResourceResourceType `protobuf:"varint,3,opt,name=resource_type,json=resourceType,proto3,enum=go_blog.blog.ResourceResourceType" json:"resource_type,omitempty"` // 资源类型 1-目录 2-接口
	Status           ResourceStatus       `protobuf:"varint,4,opt,name=status,proto3,enum=go_blog.blog.ResourceStatus" json:"status,omitempty"`                                       // 接口状态 0-未发布 1-已发布 2-以下线
	Url              string               `protobuf:"bytes,5,opt,name=url,proto3" json:"url,omitempty"`                                                                               // 接口URL
	ParentId         uint32               `protobuf:"varint,6,opt,name=parent_id,json=parentId,proto3" json:"parent_id,omitempty"`                                                    // 父接口ID
	HttpMethod       string               `protobuf:"bytes,7,opt,name=http_method,json=httpMethod,proto3" json:"http_method,omitempty"`                                               // 请求方式
	Describe         string               `protobuf:"bytes,8,opt,name=describe,proto3" json:"describe,omitempty"`                                                                     // 接口描述
...
type RoleAuthority struct {
	...
	AuthorityType RoleAuthorityAuthorityType `protobuf:"varint,3,opt,name=authority_type,json=authorityType,proto3,enum=go_blog.blog.RoleAuthorityAuthorityType" json:"authority_type,omitempty"` // 权限类型
...
func (x *RoleAuthority) GetAuthorityType() RoleAuthorityAuthorityType {
	if x != nil {
		return x.AuthorityType
	}
	return RoleAuthorityAuthorityType_UNKNOWN_AUTHORITY_TYPE
}
...
var file_auth_auth_proto_rawDesc = []byte{
	...
	0x52, 0x08, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61,
	0x74, 0x68, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x70, 0x61, 0x74, 0x68, 0x12, 0x1c,
	...
	0x08, 0x69, 0x73, 0x48, 0x69, 0x64, 0x64, 0x65, 0x6e, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x6f, 0x72,
	0x74, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x09, 0x73,
	0x6f, 0x72, 0x74, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x69, 0x63, 0x6f, 0x6e,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x63, 0x6f, 0x6e, 0x12, 0x1b, 0x0a, 0x09,
	0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x08, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x72, 0x65,
	...
	0x67, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x4d, 0x65, 0x6e, 0x75, 0x52, 0x04, 0x64, 0x61, 0x74,
	...
	0x64, 0x22, 0x14, 0x0a, 0x12, 0x41, 0x64, 0x64, 0x4f, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x4d, 0x65, 0x6e, 0x75, 0x52, 0x65, 0x71, 0x22, 0x34, 0x0a, 0x0d, 0x44, 0x65, 0x6c, 0x65, 0x74,
	0x65, 0x4d, 0x65, 0x6e, 0x75, 0x52, 0x65, 0x71, 0x12, 0x1c, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0d, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x2a, 0x02, 0x20, 0x00, 0x48, 0x00, 0x52,
	0x02, 0x69, 0x64, 0x88, 0x01, 0x01, 0x42, 0x05, 0x0a, 0x03, 0x5f, 0x69, 0x64, 0x22, 0xa1, 0x04,
	...
	0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x67, 0x6f, 0x5f, 0x62, 0x6c, 0x6f, 0x67, 0x2e,
	0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x52, 0x0c, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x34, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1c, 0x2e, 0x67, 0x6f, 0x5f, 0x62, 0x6c, 0x6f,
	0x67, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x53,
	...
	0x28, 0x0d, 0x52, 0x08, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x1f, 0x0a, 0x0b,
	0x68, 0x74, 0x74, 0x70, 0x5f, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28,
	...
	0x08, 0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x12, 0x22, 0x0a, 0x0d, 0x69, 0x73, 0x5f,
	0x6e, 0x65, 0x65, 0x64, 0x5f, 0x6c, 0x6f, 0x67, 0x69, 0x6e, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0b, 0x69, 0x73, 0x4e, 0x65, 0x65, 0x64, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x12, 0x2c, 0x0a,
	0x12, 0x69, 0x73, 0x5f, 0x6e, 0x65, 0x65, 0x64, 0x5f, 0x70, 0x65, 0x72, 0x6d, 0x69, 0x73, 0x73,
	0x69, 0x6f, 0x6e, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x10, 0x69, 0x73, 0x4e, 0x65, 0x65,
	...
	0x0c, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x12, 0x1f, 0x0a,
	0x0b, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x18, 0x0d, 0x20, 0x01,
	0x28, 0x0d, 0x52, 0x0a, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12, 0x1f,
	0x0a, 0x0b, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x18, 0x0e, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x55, 0x73, 0x65, 0x72, 0x12,
	...
	0x10, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x54, 0x69, 0x6d,
	0x65, 0x22, 0xfb, 0x01, 0x0a, 0x04, 0x52, 0x6f, 0x6c, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	0xee, 0x01, 0x0a, 0x0d, 0x52, 0x6f, 0x6c, 0x65, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x69, 0x74,
	...
	,
	...
	0x6c, 0x6f, 0x67, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x41, 0x64, 0x64, 0x4f, 0x72, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x4d, 0x65, 0x6e, 0x75, 0x52, 0x65, 0x71, 0x1a, 0x1c, 0x2e, 0x67, 0x6f,
	0x5f, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x41, 0x64, 0x64, 0x4f, 0x72,
	...
	0x65, 0x6e, 0x75, 0x12, 0x1b, 0x2e, 0x67, 0x6f, 0x5f, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x62, 0x6c,
	0x6f, 0x67, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4d, 0x65, 0x6e, 0x75, 0x52, 0x65, 0x71,
	0x1a, 0x16, 0x2e, 0x67, 0x6f, 0x5f, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e,
	...
	0x69, 0x6c, 0x12, 0x1b, 0x2e, 0x67, 0x6f, 0x5f, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x62, 0x6c, 0x6f,
	0x67, 0x2e, 0x4d, 0x65, 0x6e, 0x75, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x65, 0x71, 0x1a,
	0x12, 0x2e, 0x67, 0x6f, 0x5f, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x62, 0x6c, 0x6f, 0x67, 0x2e, 0x4d,
	0x65, 0x6e, 0x75, 0x22, 0x1a, 0x8a, 0xb5, 0x18, 0x16, 0x2f, 0x61, 0x75, 0x74, 0x68, 0x2f, 0x61,
	0x64, 0x6d, 0x69, 0x6e, 0x2f, 0x6d, 0x65, 0x6e, 0x75, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x42,
	0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x61,
	0x6b, 0x65, 0x72, 0x2d, 0x79, 0x75, 0x61, 0x6e, 0x2f, 0x67, 0x6f, 0x2d, 0x62, 0x6c, 0x6f, 0x67,
...
var file_auth_auth_proto_goTypes = []interface{}{
	(ResourceResourceType)(0),       // 0: go_blog.blog.ResourceResourceType
	(ResourceStatus)(0),             // 1: go_blog.blog.ResourceStatus
	(RoleAuthorityAuthorityType)(0), // 2: go_blog.blog.RoleAuthorityAuthorityType
	(*EmptyRsp)(nil),                // 3: go_blog.blog.EmptyRsp
	(*AddOrUpdateRsp)(nil),          // 4: go_blog.blog.AddOrUpdateRsp
	(*Menu)(nil),                    // 5: go_blog.blog.Menu
	(*SearchMenuReq)(nil),           // 6: go_blog.blog.SearchMenuReq
	(*SearchMenuRsp)(nil),           // 7: go_blog.blog.SearchMenuRsp
	(*MenuDetailReq)(nil),           // 8: go_blog.blog.MenuDetailReq
	(*AddOrUpdateMenuReq)(nil),      // 9: go_blog.blog.AddOrUpdateMenuReq
	(*DeleteMenuReq)(nil),           // 10: go_blog.blog.DeleteMenuReq
	(*Resource)(nil),                // 11: go_blog.blog.Resource
	(*Role)(nil),                    // 12: go_blog.blog.Role
	(*RoleAuthority)(nil),           // 13: go_blog.blog.RoleAuthority
}
var file_auth_auth_proto_depIdxs = []int32{
	5,  // 0: go_blog.blog.SearchMenuRsp.data:type_name -> go_blog.blog.Menu
	0,  // 1: go_blog.blog.Resource.resource_type:type_name -> go_blog.blog.ResourceResourceType
	1,  // 2: go_blog.blog.Resource.status:type_name -> go_blog.blog.ResourceStatus
	2,  // 3: go_blog.blog.RoleAuthority.authority_type:type_name -> go_blog.blog.RoleAuthorityAuthorityType
	6,  // 4: go_blog.blog.AuthApi.SearchMenu:input_type -> go_blog.blog.SearchMenuReq
	9,  // 5: go_blog.blog.AuthApi.AddOrUpdateMenu:input_type -> go_blog.blog.AddOrUpdateMenuReq
	10, // 6: go_blog.blog.AuthApi.DeleteMenu:input_type -> go_blog.blog.DeleteMenuReq
	8,  // 7: go_blog.blog.AuthApi.MenuDetail:input_type -> go_blog.blog.MenuDetailReq
	7,  // 8: go_blog.blog.AuthApi.SearchMenu:output_type -> go_blog.blog.SearchMenuRsp
	4,  // 9: go_blog.blog.AuthApi.AddOrUpdateMenu:output_type -> go_blog.blog.AddOrUpdateRsp
	3,  // 10: go_blog.blog.AuthApi.DeleteMenu:output_type -> go_blog.blog.EmptyRsp
	5,  // 11: go_blog.blog.AuthApi.MenuDetail:output_type -> go_blog.blog.Menu
