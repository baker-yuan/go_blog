...
var file_blog_blog_proto_rawDesc = []byte{
	...
	0x52, 0x02, 0x69, 0x64, 0x2a, 0x2e, 0x0a, 0x0c, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65,
	...
	0x32, 0xc0, 0x03, 0x0a, 0x07, 0x42, 0x6c, 0x6f, 0x67, 0x41, 0x70, 0x69, 0x12, 0x6e, 0x0a, 0x0d,
	...
	0x61, 0x69, 0x6c, 0x42, 0x2d, 0x5a, 0x2b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x62, 0x61, 0x6b, 0x65, 0x72, 0x2d, 0x79, 0x75, 0x61, 0x6e, 0x2f, 0x67, 0x6f, 0x2d,
	0x62, 0x6c, 0x6f, 0x67, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x2f, 0x62, 0x6c,
...
var file_blog_blog_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
...
var file_blog_blog_proto_goTypes = []interface{}{
	...
	(*EmptyRsp)(nil),              // 5: go_blog.blog.EmptyRsp
	(*AddOrUpdateRsp)(nil),        // 6: go_blog.blog.AddOrUpdateRsp
	(*Article)(nil),               // 7: go_blog.blog.Article
	(*SearchArticleReq)(nil),      // 8: go_blog.blog.SearchArticleReq
	(*SearchArticleRsp)(nil),      // 9: go_blog.blog.SearchArticleRsp
	(*ArticleDetailReq)(nil),      // 10: go_blog.blog.ArticleDetailReq
	(*AddOrUpdateArticleReq)(nil), // 11: go_blog.blog.AddOrUpdateArticleReq
	(*DeleteArticleReq)(nil),      // 12: go_blog.blog.DeleteArticleReq
}
var file_blog_blog_proto_depIdxs = []int32{
	...
	7,  // 4: go_blog.blog.SearchArticleRsp.data:type_name -> go_blog.blog.Article
	...
	8,  // 9: go_blog.blog.BlogApi.SearchArticle:input_type -> go_blog.blog.SearchArticleReq
	11, // 10: go_blog.blog.BlogApi.AddOrUpdateArticle:input_type -> go_blog.blog.AddOrUpdateArticleReq
	12, // 11: go_blog.blog.BlogApi.DeleteArticle:input_type -> go_blog.blog.DeleteArticleReq
	10, // 12: go_blog.blog.BlogApi.ArticleDetail:input_type -> go_blog.blog.ArticleDetailReq
	9,  // 13: go_blog.blog.BlogApi.SearchArticle:output_type -> go_blog.blog.SearchArticleRsp
	6,  // 14: go_blog.blog.BlogApi.AddOrUpdateArticle:output_type -> go_blog.blog.AddOrUpdateRsp
	5,  // 15: go_blog.blog.BlogApi.DeleteArticle:output_type -> go_blog.blog.EmptyRsp
	7,  // 16: go_blog.blog.BlogApi.ArticleDetail:output_type -> go_blog.blog.Article
